...
Summarization](https://proactiveprogrammers.com/discrete-structures/engineering-efforts/data-summarization/)
...
- Specifically, you can change into the program directory by typing `cd rootfinder`.
